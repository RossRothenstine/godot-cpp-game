...
xcodebuild -create-xcframework -library ./project/bin/libgamecode.ios.$1.a -library ./project/bin/libgamecode.ios.$1.simulator.a -output ./project/bin/libgamecode.ios.$1.xcframework
